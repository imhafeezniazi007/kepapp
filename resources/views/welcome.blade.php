...
@section('content')
    <section>
        <div class="slideshow-container w-full relative ">
            ...
            <div class="mySlides fade">
                <img src="{{asset("./assets/APF_5701.JPG")}}" class="h-[35rem] md:h-[55rem] lg:h-[60rem]" style="width:100%">
            </div>
            <div class="mySlides fade">
    ...
    <section class="mt-8 gradient-one overflow-hidden" data-aos="zoom-in" data-aos-duration="2000">
        <div class="text-center flex flex-col justify-center md:flex md:flex-row md:justify-around md:items-center lg:flex lg:flex-row lg:justify-around lg:items-center">
            <div class="w-full px-2 pb-2 text-white md:pr-6 md:text-custim-green lg:w-2/3 lg:text-custom-green" data-aos="fade-right" data-aos-duration="2000">
                <h1 class="text-lg text-center pt-10 md:text-4xl md:mb-8 lg:text-4xl lg:mb-8">Our mission is to uplift orphan children and youth in every aspect or field of their life despite their religion, caste, area</h1>
                <p class="text-md text-center md:text-xl lg:text-xl">This noble initiative was taken to make the youth independent and to uplift the orphan children of a society that is always being the backend. This step helps to bring positivity and unity in the society which is the need of the hour.</p>
            </div>
            <div class="md:w-2/4 md:relative lg:w-2/3 lg:h-[35rem] lg:relative" data-aos="fade-left" data-aos-duration="3000">
    ...
    <section class="md:my-8 lg:my-8 gradient-two overflow-hidden" data-aos="zoom-out" data-aos-duration="2000">
            <div class="flex flex-col-reverse md:flex md:flex-row md:justify-around md:items-center md:w-3/4 lg:w-full lg:flex lg:flex-row lg:justify-between lg:items-center">
                <div class="md:w-2/3 lg:w-[60%] lg:h-[35rem]" data-aos="fade-right" data-aos-duration="2000"><img src="{{ asset("/assets/main2.jpeg") }}" alt=""></div>
                <div class="pt-4 px-2 text-center md:w-2/4 lg:w-3/5 text-white md:text-custom-green lg:text-custom-green" data-aos="fade-left" data-aos-duration="3000">
                    <h1 class="text-3xl lg:text-5xl lg:mb-8 md:text-5xl md:mb-8 md:pr-2">Our Mission</h1>
                    <p class="text-xl py-4 md:text-3xl lg:text-3xl">"We are here to promote positivity and to bring youth together for one mission."</p>
                </div>
            </div>
    </section>
    <section class="md:my-8 lg:my-8 gradient-three overflow-hidden" data-aos="zoom-out" data-aos-duration="2000">
        <div class="flex flex-col-reverse md:flex md:flex-row md:justify-around md:items-center md:w-3/4 lg:w-full lg:flex lg:flex-row-reverse lg:justify-between lg:items-center">
            <div class="md:w-2/3 lg:w-[60%] lg:h-[35rem]" data-aos="fade-right" data-aos-duration="2000"><img src="{{ asset("/assets/main3.jpeg") }}" alt=""></div>
            <div class="pt-4 px-2 text-white md:w-2/4 lg:w-3/5 lg:p-4 lg:text-custom-green" data-aos="fade-left" data-aos-duration="3000">
                <h1 class="text-3xl py-2 text-center lg:text-5xl lg:mb-8 md:text-5xl md:mb-8 md:pr-2">Our Vision</h1>
                <p class="text-xl text-center mb-8 md:text-3xl md:text-white lg:text-3xl lg:text-custom-green">"We promote education, health and self-confidence among youth specifically orphans, and to keep them active to make them able to be successful in every field of life."</p>
            </div>
        </div>
    </section>
    <section class="my-8">
