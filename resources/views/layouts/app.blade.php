...
<nav class="flex flex-col md:flex md:flex-row md:justify-between md:items-center md:p-3 lg:flex lg:flex-row lg:justify-between lg:items-center lg:p-3 text-xl bg-gray-50 sticky z-50 top-0">
    ...
    <div id="panel" class="flex flex-col justify-start md:flex md:flex-row md:justify-between md:items-center lg:flex lg:flex-row lg:justify-between lg:items-center ">
        <ul class="flex flex-col justify-start p-3 md:flex md:flex-row md:items-center md:space-x-2 lg:flex lg:flex-row lg:justify-start lg:items-center lg:space-x-4">
            ...
            <li class="my-4 lg:my-0 md:my-0"><a href="{{ route('ourTeam') }}" class="text-xl rounded text-custom-green bg-gray-50 hover:text-white hover:bg-custom-green p-3 {{ (request()->is('OurTeam')) ? 'border-2 border-custom-green' : '' }}"><button>Core Team</button></a></li>
    ...
    <div class="flex flex-row justify-evenly items-center text-center pr-4 md:flex md:flex-row md:justify-between md:items-center lg:flex lg:flex-row lg:justify-between lg:items-center px-8">
        ...
        <div class="flex flex-col md:flex md:flex-row md:items-center lg:flex lg:flex-row lg:items-center space-x-2">
           ...
           <div class="flex flex-row space-x-2">
               ...
               <a target="_blank" href="https://twitter.com/kep_trust?t=IOEWsyG5dJLhSIbnkOQ7gw&s=09"><i class="fab fa-twitter fa-lg p-2 rounded bg-[#1DA1F2] text-white hover:bg-custom-green"></i></a>
               <a target="_blank" href="https://www.instagram.com/kep.trust/"><i class="fab fa-instagram fa-lg p-2 rounded bg-[#E4405F] text-white hover:bg-custom-green"></i></a>
               <a target="_blank" href="https://youtube.com/@kep_trust"><i class="fab fa-youtube fa-lg p-2 rounded bg-[#FF0000] text-white hover:bg-custom-green"></i></a>
               <a target="_blank" href="https://www.linkedin.com/company/keptrustofficial/"><i class="fab fa-linkedin fa-lg p-2 rounded bg-[#5271FF] text-white hover:bg-custom-green"></i></a>
               <a target="_blank" href="https://wa.me/923001596565"><i class="fab fa-whatsapp fa-lg p-2 rounded bg-[#11c71f] text-white hover:bg-custom-green"></i></a>
           </div>
        </div>
    </div>
</footer>
